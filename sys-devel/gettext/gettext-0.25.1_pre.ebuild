...
inherit flag-o-matic java-pkg-opt-2 libtool multilib-minimal verify-sig toolchain-funcs poly-c_ebuilds
...
if [[ ${MY_PV} == *_rc* ]] ; then
	SRC_URI="
		https://alpha.gnu.org/gnu/${PN}/${MY_P/_/-}.tar.xz
		verify-sig? ( https://alpha.gnu.org/gnu/${PN}/${MY_P/_/-}.tar.xz.sig )
	"
	S="${WORKDIR}/${MY_P/_/-}"
else
	SRC_URI="
