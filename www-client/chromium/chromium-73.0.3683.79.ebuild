...
src_prepare() {
	...
	for p in $(cat "${FILESDIR}/debian-patches-73/series");do eapply "${FILESDIR}/debian-patches-73/$p";done
	...
	for p in $(cat "${FILESDIR}/opensuse-patches-73/series");do eapply "${FILESDIR}/opensuse-patches-73/$p";done
