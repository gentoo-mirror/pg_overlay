...
src_prepare() {
	...
	use kde && for i in $(cat "${FILESDIR}/kde-opensuse/series"); do eapply "${FILESDIR}/kde-opensuse/$i"; done && cp "${FILESDIR}/kde-opensuse/kde.js-1" obj-x86_64-pc-linux-gnu/dist/bin/defaults/pref/kde.js
