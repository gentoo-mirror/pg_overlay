...
src_prepare() {
	...
	use wayland && "${FILESDIR}/fedora-patchset-$(get_major_version)"/firefox-disable-ffvpx-with-vapi.patch && eapply "${FILESDIR}/fedora-patchset-$(get_major_version)"/mozilla-1634213.patch
