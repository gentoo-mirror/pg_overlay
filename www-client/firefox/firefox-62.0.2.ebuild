...
src_prepare() {
	...
	eapply "${FILESDIR}"/${PN}-60.0-sandbox-clang.patch # 627506
	...
	#rm -fr browser/extensions/{activity-stream,aushelper,formautofill,onboarding,pdfjs,pocket,webcompat,webcompat-reporter} || die
