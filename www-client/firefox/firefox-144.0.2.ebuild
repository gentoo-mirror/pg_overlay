...
# Firefox-only IUSE
IUSE+=" +gmp-autoupdate gnome-shell jpegxl +jumbo-build openh264 +telemetry wasm-sandbox +privacy"
...
src_prepare() {
	...
	rm "${WORKDIR}"/firefox-patches/0023-bmo-1990430-make-autobuffer-trivially-copyable.patch
	...
	rm -rfv browser/extensions/{formautofill,pictureinpicture,report-site-issue,screenshots,webcompat}
