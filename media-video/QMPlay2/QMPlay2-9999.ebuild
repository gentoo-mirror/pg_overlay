...
src_configure() {
	...
	if use extensions; then
		...
		mycmakeargs+=( -DUSE_EXTENSIONS=OFF -DUSE_MPRIS2=OFF -DUSE_LASTF=OFF MDUSE_TEKSTOWO=OFF -DUSE_DATMUSIC=OFF -DUSE_ANIMEODCINKI=OFF -DUSE_WBIJAM=OFF -DDUSE_MEDIABROWSER=OFF)
	fi
