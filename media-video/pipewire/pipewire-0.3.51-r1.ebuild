...
SLOT="0/0.4"
IUSE="bluetooth doc echo-cancel extra gstreamer jack-client jack-sdk lv2 pipewire-alsa ssl system-service systemd test udev v4l X zeroconf vulkan"
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-0.3.50-fix-spa-header.patch
)
