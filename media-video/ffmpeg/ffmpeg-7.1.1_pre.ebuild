...
inherit flag-o-matic multilib multilib-minimal toolchain-funcs ${SCM} poly-c_ebuilds
...
src_unpack() {
	if use verify-sig; then
		verify-sig_verify_detached "${DISTDIR}"/${MY_P/_/-}.tar.xz{,.asc} /usr/share/openpgp-keys/ffmpeg.asc
