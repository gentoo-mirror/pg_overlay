...
libadbd = compile(expand("core/adb", adbdfiles), '-DADB_VERSION="\"$PKGVER\"" -DADB_HOST=1 -Icore/include -Icore/base/include -Icore/adb -Icore/libcrypto_utils/include')
...
libcrypto = compile(expand("core/libcrypto_utils", libcryptofiles), "-Icore/libcrypto_utils/include")
link("adb", libbase + liblog + libcutils + libadbd + libadb + libdiagnoseusb + libcrypto, "-lboringssl_crypto -lpthread -lusb-1.0")
...
libext4 = compile(expand("extras/ext4_utils", ext4files), "-D_GNU_SOURCE -Icore/libsparse/include -Icore/include -I/usr/include/selinux -Iextras/ext4_utils/include")

link("fastboot", libsparse + libzip + libcutils + liblog + libutil + libbase + libext4 + f2fs + libfastboot + libdiagnoseusb, "-lz -lpcre2-8 -lselinux -lsepol -lpthread -ldl")
...
e2fsdroid = compile(expand("e2fsprogs", e2fsdroidfiles), "-Ie2fsprogs/lib -Ie2fsprogs/lib/ext2fs -I/usr/include/selinux -Icore/libcutils/include -Ie2fsprogs/misc")

link("e2fsdroid", e2fsdroid + libext2fs + libsparse + libbase + libzip + liblog + libutil + libcutils, "-lz -lselinux -lsepol -lpthread -lpcre2-8")
