...
SRC_URI="https://github.com/arvidn/libtorrent/releases/download/libtorrent-1_1/libtorrent-rasterbar-${PV}.tar.gz -> rb_libtorrent-${PV}.tar.gz"
...
sed -i "s|-L[^ ]*/src/.libs|-L${S}/src/.libs|" bindings/python/link_flags.in || die
