...
PLOCALE_BACKUP="en"
inherit autotools distutils-r1 lua-single plocale toolchain-funcs poly-c_ebuilds
...
if [[ ${MY_PV} == *9999* ]] ; then
	...
	SRC_URI="https://nmap.org/dist/${MY_P}.tar.bz2"
	SRC_URI+=" verify-sig? ( https://nmap.org/dist/sigs/${MY_P}.tar.bz2.asc )"

	KEYWORDS="~alpha ~amd64 ~arm ~arm64 ~hppa ~mips ~ppc ~ppc64 ~riscv ~s390 ~sparc ~x86 ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos"
fi

SRC_URI+=" https://www.gentoofan.org/gentoo/dist/${PN}-7.96_pre-patches.tar.xz"	
