...
REAL_PN=VBoxGuestAdditions
REAL_P=${REAL_PN}_${MY_PV}

DESCRIPTION="CD image containing guest additions for VirtualBox"
HOMEPAGE="https://www.virtualbox.org/"
SRC_URI="https://download.virtualbox.org/virtualbox/${MY_PV}/${REAL_P}.iso"
...
src_install() {
	...
	newins "${DISTDIR}"/${REAL_P}.iso ${REAL_PN}.iso
}
