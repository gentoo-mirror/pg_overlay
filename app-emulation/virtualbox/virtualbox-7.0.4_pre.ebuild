...
inherit desktop edo flag-o-matic java-pkg-opt-2 linux-info multilib optfeature pax-utils python-single-r1 tmpfiles toolchain-funcs udev xdg poly-c_ebuilds
...
SRC_URI="https://download.virtualbox.org/virtualbox/${MY_PV}/${REAL_P}.tar.bz2
