...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="alsa debug doc headless java libressl lvm pam pax_kernel pulseaudio +opengl python +qt5 +sdk +udev vboxwebsrv vnc opus"
...
src_configure() {
	local myconf=(
		...
		$(usex vnc --enable-vnc '')
		$(usex opus --enable-system-libopus '')
	)
