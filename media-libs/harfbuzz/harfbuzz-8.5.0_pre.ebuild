...
inherit flag-o-matic meson-multilib python-any-r1 xdg-utils poly-c_ebuilds
...
if [[ ${MY_PV} == 9999 ]] ; then
	...
	SRC_URI="https://github.com/harfbuzz/harfbuzz/releases/download/${MY_PV}/${MY_P}.tar.xz"
