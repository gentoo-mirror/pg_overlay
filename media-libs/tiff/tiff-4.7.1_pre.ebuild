...
inherit libtool multilib-minimal verify-sig flag-o-matic poly-c_ebuilds

REAL_P="${MY_P/_rc/rc}"
DESCRIPTION="Tag Image File Format (TIFF) library"
HOMEPAGE="http://libtiff.maptools.org"
SRC_URI="https://download.osgeo.org/libtiff/${REAL_P}.tar.xz"
SRC_URI+=" verify-sig? ( https://download.osgeo.org/libtiff/${REAL_P}.tar.xz.sig )"
