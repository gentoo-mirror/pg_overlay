...
inherit autotools verify-sig poly-c_ebuilds
...
if [[ ${MY_PV} = 9999* ]]; then
	...
	SRC_URI="
		https://dist.libuv.org/dist/v${MY_PV}/libuv-v${MY_PV}.tar.gz -> ${MY_P}.tar.gz
		verify-sig? ( https://dist.libuv.org/dist/v${MY_PV}/libuv-v${MY_PV}.tar.gz.sign -> ${MY_P}.tar.gz.sig )
	"
