...
src_prepare() {
	...
	# @PYTHON@
	sed -i 's/@PYTHON@/python/g' gobject/glib-mkenums.in > gobject/glib-mkenums || die
	sed -i 's/@PYTHON@/python/g' gobject/glib-genmarshal.in > gobject/glib-genmarshal || die
