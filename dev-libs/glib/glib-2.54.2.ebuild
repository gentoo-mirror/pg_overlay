...
src_prepare() {
	...
	# @PYTHON@
	sed -e 's/@PYTHON@/python/g' gobject/glib-mkenums.in > gobject/glib-mkenums || die
	sed -e 's/@PYTHON@/python/g' gobject/glib-genmarshal.in > gobject/glib-genmarshal || die
