...
inherit autotools elisp-common flag-o-matic multilib-minimal toolchain-funcs poly-c_ebuilds
...
if [[ "${MY_PV}" == "9999" ]]; then
	...
	SRC_URI="https://github.com/protocolbuffers/${PN}/archive/v${MY_PV}.tar.gz -> ${MY_P}.tar.gz"
fi
