...
# * https://www.boost.org/users/history/version_${REAL_PV}.html
...
SRC_URI="https://boostorg.jfrog.io/artifactory/main/release/${MY_PV}/source/boost_${REAL_PV}.tar.bz2"
S="${WORKDIR}/${PN}_${REAL_PV}"

LICENSE="Boost-1.0"
SLOT="0/${MY_PV}.1" # ${MY_PV} instead of the major version due to bug 486122
