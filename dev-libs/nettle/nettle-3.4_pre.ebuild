...
inherit autotools multilib-build multilib-minimal multilib toolchain-funcs poly-c_ebuilds
...
SLOT="0/6.2" # subslot = libnettle soname version, .1 as broke ABI bug#601512
