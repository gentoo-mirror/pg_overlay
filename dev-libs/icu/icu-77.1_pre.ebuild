...
inherit autotools multilib-minimal python-any-r1 toolchain-funcs verify-sig poly-c_ebuilds
...
SRC_URI="https://github.com/unicode-org/icu/releases/download/release-${REAL_PV/_/-}/icu4c-${REAL_PV/-rc/rc}-src.tgz"
SRC_URI+=" verify-sig? ( https://github.com/unicode-org/icu/releases/download/release-${REAL_PV/_/-}/icu4c-${REAL_PV/-rc/rc}-src.tgz.asc )"
S="${WORKDIR}"/${PN}/source
