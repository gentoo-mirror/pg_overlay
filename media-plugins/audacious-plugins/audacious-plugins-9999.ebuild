...
SLOT="0"
KEYWORDS=""
IUSE="aac alsa bs2b cdda +cue +ffmpeg +flac fluidsynth +gnome +http gtk3 
jack lame libnotify libsamplerate lirc mms mp3 nls +pulseaudio +qt5 scrobbler 
sdl sid sndfile vorbis +wavpack"
