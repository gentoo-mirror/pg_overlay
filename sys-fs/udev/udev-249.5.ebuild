...
# $Id: d4a8800599fef216ec30af5b5211f4dcff80f742 $
...
if [[ ${PV} = 9999* ]] ; then
	...
	SRC_URI+="
		elibc_musl? (
			https://dev.gentoo.org/~gyakovlev/distfiles/systemd-musl-patches-249.1-r1.tar.xz
			https://dev.gentoo.org/~soap/distfiles/systemd-musl-patches-249.1-r1.tar.xz
	)"
...
SLOT="0"
IUSE="acl hwdb +kmod selinux test"
RESTRICT="!test? ( test )"
