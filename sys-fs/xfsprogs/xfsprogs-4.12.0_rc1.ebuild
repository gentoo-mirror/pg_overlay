...
inherit bash-completion-r1 eutils toolchain-funcs multilib versionator

DESCRIPTION="xfs filesystem utilities"
HOMEPAGE="http://oss.sgi.com/projects/xfs/"
MY_PV="${PV/_/-}"
SRC_URI="https://git.kernel.org/pub/scm/fs/xfs/${PN}-dev.git/snapshot/${PN}-dev-${MY_PV}.tar.gz -> ${P}.tar.gz"
