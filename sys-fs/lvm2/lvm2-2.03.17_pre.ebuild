...
# $Id: 70e6c17be7d5a12921a1d8febfc864082609eab9 $

EAPI=8

TMPFILES_OPTIONAL=1
inherit autotools linux-info systemd toolchain-funcs tmpfiles udev flag-o-matic poly-c_ebuilds

DESCRIPTION="User-land utilities for LVM2 (device-mapper) software"
HOMEPAGE="https://sourceware.org/lvm2/"
SRC_URI="https://sourceware.org/ftp/lvm2/${PN^^}.${MY_PV}.tgz"
S="${WORKDIR}/${PN^^}.${MY_PV}"
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-2.03.16-mksh_build.patch #686652
)
...
src_prepare() {
	...
	if ! use systemd ; then
		eapply "${FILESDIR}"/${PN}-2.03.15-dm_lvm_rules_no_systemd.patch
	fi
