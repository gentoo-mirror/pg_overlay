...
if [[ ${PV} == *_rc* ]] ; then
	MY_PV="$(ver_rs 1- -)"
	SRC_URI="https://git.linux-nfs.org/?p=steved/nfs-utils.git;a=snapshot;h=9f974046c37b7c28705d5558328759fff708b1cb;sf=tgz -> ${P}.tar.gz"
	S="${WORKDIR}/${PN}-${PN}-${MY_PV}"
else
	SRC_URI="https://www.kernel.org/pub/linux/utils/${PN}/${PV}/${P}.tar.xz"
