...
# @FUNCTION: strip-l10n
# @USAGE: [<allow L10N>|<-i|-u> <directories of .po files>]
# @DESCRIPTION:
# Make sure that L10N only contains languages that
# a package can support.  The first form allows you to
# specify a list of L10N.  The -i builds a list of po
...
strip-l10n() {
	...
	[[ -n ${nols} ]] \
		&& einfo "Sorry, but ${PN} does not support the L10N:" ${nols}
	export L10N=${newls:1}
}
