...
# determining the cross-section between the user's set L10N and what
...
# the package. Check profiles/desc/l10n.desc to see if the locales
...
# @USAGE: [disabled]
# @DESCRIPTION:
# Determine which L10N the user has enabled that are offered by the
