...
SRC_URI="https://launchpad.net/${PN}/trunk/${PV}/+download/${MY_PV}.tar.gz"

LICENSE="GPL-2+"
SLOT="0"
KEYWORDS="~amd64 ~arm ~x86 ~amd64-linux ~x86-linux"
IUSE="cups +dbus djvu fitz +pdf postscript qt5 +sqlite +svg synctex image"
...
src_configure() {
	local myconfig=() i=
	for i in cups dbus djvu pdf svg synctex image; do
