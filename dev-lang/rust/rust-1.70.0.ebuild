...
MY_P="rustc-nightly"
SLOT="nightly/${PV}"
SRC="rustc-nightly-src.tar.xz -> rustc-${PV}-src.tar.xz"
...
SRC_URI="
	https://static.rust-lang.org/dist/rustc-nightly-src.tar.xz -> rustc-${PV}-src.tar.xz
	verify-sig? ( https://static.rust-lang.org/dist/${SRC}.asc )
	!system-bootstrap? ( $(rust_all_arch_uris rust-nightly ) )
"
...
src_prepare() {
	if ! use system-bootstrap; then
		...
		local rust_stage0="rust-nightly-$(rust_abi)"
